import { WORKOUT_PLANS_STORE } from "../../database_stores";
import { 
    InsertWithRelations,
    Update,
    DeleteWithRelations,
...
export async function DeleteWorkoutPlan(key) {
    DeleteWithRelations(WORKOUT_PLANS_STORE, key);
}

// select
export async function SelectAllWorkoutPlans(setWorkoutPlans) {
    return SelectAll(WORKOUT_PLANS_STORE, setWorkoutPlans);
}